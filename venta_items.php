    ...
    <div class="container">
		...
		<div class="panel-heading">
		    <div class="pull-right">
				 <a  href="nueva_ventaItems.php" class="btn btn-success"><span class="glyphicon glyphicon-plus" ></span> Nueva Venta</a>
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Venta</h4>
		</div>
